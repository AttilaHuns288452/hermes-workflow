...
**694 agent skills · /decide routing brain · 4-layer free model chain**
...
[![Skills](https://img.shields.io/badge/Skills-694-4a8cf4?style=flat&labelColor=0b0f1c)](https://attilahuns288452.github.io/hermes-workflow/)
...
**One install, zero config.** Clone this repo, run one command, and your AI assistant gets 694 skills across 10 domains — coding, design, finance, media, research, DevOps, and more — all on free models.
...
cd hermes-workflow
# Install 694 skills in one shot
