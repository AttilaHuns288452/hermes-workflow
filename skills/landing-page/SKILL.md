...
- No clear next step
- **Promotional CTAs in sub-sections** — cross-utility CTAs (shadows, animations, components) belong on the first-view landing page, not buried inside component template tabs.
