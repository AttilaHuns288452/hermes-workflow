...
name: od-clickhouse
description: >-
  Open Design design system (Clickhouse). Use when the user wants an interface
  styled as Clickhouse, or any design task where this aesthetic fits the brief.
  Full spec: DESIGN.md in this skill folder.
---

# Clickhouse — Open Design Design System
