...
name: od-tesla
description: >-
  Open Design design system (Tesla). Use when the user wants an interface
  styled as Tesla, or any design task where this aesthetic fits the brief.
  Full spec: DESIGN.md in this skill folder.
---

# Tesla — Open Design Design System
