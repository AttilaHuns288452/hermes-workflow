...
name: od-revolut
description: >-
  Open Design design system (Revolut). Use when the user wants an interface
  styled as Revolut, or any design task where this aesthetic fits the brief.
  Full spec: DESIGN.md in this skill folder.
---

# Revolut — Open Design Design System
