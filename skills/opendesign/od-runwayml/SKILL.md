...
name: od-runwayml
description: >-
  Open Design design system (Runwayml). Use when the user wants an interface
  styled as Runwayml, or any design task where this aesthetic fits the brief.
  Full spec: DESIGN.md in this skill folder.
---

# Runwayml — Open Design Design System
