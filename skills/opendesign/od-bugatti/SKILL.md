...
name: od-bugatti
description: >-
  Open Design design system (Bugatti). Use when the user wants an interface
  styled as Bugatti, or any design task where this aesthetic fits the brief.
  Full spec: DESIGN.md in this skill folder.
---

# Bugatti — Open Design Design System
