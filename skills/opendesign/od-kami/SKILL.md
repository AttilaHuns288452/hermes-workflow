...
name: od-kami
description: >-
  Open Design design system (Kami). Use when the user wants an interface
  styled as Kami, or any design task where this aesthetic fits the brief.
  Full spec: DESIGN.md in this skill folder.
---

# Kami — Open Design Design System
