...
name: od-xiaohongshu
description: >-
  Open Design design system (Xiaohongshu). Use when the user wants an interface
  styled as Xiaohongshu, or any design task where this aesthetic fits the brief.
  Full spec: DESIGN.md in this skill folder.
---

# Xiaohongshu — Open Design Design System
