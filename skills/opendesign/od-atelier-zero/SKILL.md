---
name: od-atelier-zero
description: >-
  Open Design design system (Atelier Zero). Use when the user wants an interface
  styled as Atelier Zero, or any design task where this aesthetic fits the brief.
  Full spec: DESIGN.md in this skill folder.
---

# Atelier Zero — Open Design Design System
