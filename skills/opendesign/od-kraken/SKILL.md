...
name: od-kraken
description: >-
  Open Design design system (Kraken). Use when the user wants an interface
  styled as Kraken, or any design task where this aesthetic fits the brief.
  Full spec: DESIGN.md in this skill folder.
---

# Kraken — Open Design Design System
