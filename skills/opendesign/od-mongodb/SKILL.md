...
name: od-mongodb
description: >-
  Open Design design system (Mongodb). Use when the user wants an interface
  styled as Mongodb, or any design task where this aesthetic fits the brief.
  Full spec: DESIGN.md in this skill folder.
---

# Mongodb — Open Design Design System
