...
name: od-nike
description: >-
  Open Design design system (Nike). Use when the user wants an interface
  styled as Nike, or any design task where this aesthetic fits the brief.
  Full spec: DESIGN.md in this skill folder.
---

# Nike — Open Design Design System
