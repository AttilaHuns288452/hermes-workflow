...
name: od-elevenlabs
description: >-
  Open Design design system (Elevenlabs). Use when the user wants an interface
  styled as Elevenlabs, or any design task where this aesthetic fits the brief.
  Full spec: DESIGN.md in this skill folder.
---

# Elevenlabs — Open Design Design System
