...
name: od-cohere
description: >-
  Open Design design system (Cohere). Use when the user wants an interface
  styled as Cohere, or any design task where this aesthetic fits the brief.
  Full spec: DESIGN.md in this skill folder.
---

# Cohere — Open Design Design System
