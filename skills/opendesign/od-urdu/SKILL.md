...
name: od-urdu
description: >-
  Open Design design system (Urdu). Use when the user wants an interface
  styled as Urdu, or any design task where this aesthetic fits the brief.
  Full spec: DESIGN.md in this skill folder.
---

# Urdu — Open Design Design System
