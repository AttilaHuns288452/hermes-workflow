...
name: od-starbucks
description: >-
  Open Design design system (Starbucks). Use when the user wants an interface
  styled as Starbucks, or any design task where this aesthetic fits the brief.
  Full spec: DESIGN.md in this skill folder.
---

# Starbucks — Open Design Design System
