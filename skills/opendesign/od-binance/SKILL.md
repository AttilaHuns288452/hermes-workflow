...
name: od-binance
description: >-
  Open Design design system (Binance). Use when the user wants an interface
  styled as Binance, or any design task where this aesthetic fits the brief.
  Full spec: DESIGN.md in this skill folder.
---

# Binance — Open Design Design System
