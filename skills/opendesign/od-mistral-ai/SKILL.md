...
name: od-mistral-ai
description: >-
  Open Design design system (Mistral Ai). Use when the user wants an interface
  styled as Mistral Ai, or any design task where this aesthetic fits the brief.
  Full spec: DESIGN.md in this skill folder.
---

# Mistral Ai — Open Design Design System
