...
name: od-uber
description: >-
  Open Design design system (Uber). Use when the user wants an interface
  styled as Uber, or any design task where this aesthetic fits the brief.
  Full spec: DESIGN.md in this skill folder.
---

# Uber — Open Design Design System
