...
name: od-wired
description: >-
  Open Design design system (Wired). Use when the user wants an interface
  styled as Wired, or any design task where this aesthetic fits the brief.
  Full spec: DESIGN.md in this skill folder.
---

# Wired — Open Design Design System
