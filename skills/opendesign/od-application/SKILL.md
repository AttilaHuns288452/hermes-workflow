...
name: od-application
description: >-
  Open Design design system (Application). Use when the user wants an interface
  styled as Application, or any design task where this aesthetic fits the brief.
  Full spec: DESIGN.md in this skill folder.
---

# Application — Open Design Design System
