...
name: od-theverge
description: >-
  Open Design design system (Theverge). Use when the user wants an interface
  styled as Theverge, or any design task where this aesthetic fits the brief.
  Full spec: DESIGN.md in this skill folder.
---

# Theverge — Open Design Design System
