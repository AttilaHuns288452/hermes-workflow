...
name: od-expo
description: >-
  Open Design design system (Expo). Use when the user wants an interface
  styled as Expo, or any design task where this aesthetic fits the brief.
  Full spec: DESIGN.md in this skill folder.
---

# Expo — Open Design Design System
