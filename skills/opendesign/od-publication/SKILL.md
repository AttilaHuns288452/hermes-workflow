...
name: od-publication
description: >-
  Open Design design system (Publication). Use when the user wants an interface
  styled as Publication, or any design task where this aesthetic fits the brief.
  Full spec: DESIGN.md in this skill folder.
---

# Publication — Open Design Design System
