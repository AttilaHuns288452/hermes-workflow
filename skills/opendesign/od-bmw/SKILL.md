...
name: od-bmw
description: >-
  Open Design design system (Bmw). Use when the user wants an interface
  styled as Bmw, or any design task where this aesthetic fits the brief.
  Full spec: DESIGN.md in this skill folder.
---

# Bmw — Open Design Design System
