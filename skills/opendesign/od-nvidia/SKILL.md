...
name: od-nvidia
description: >-
  Open Design design system (Nvidia). Use when the user wants an interface
  styled as Nvidia, or any design task where this aesthetic fits the brief.
  Full spec: DESIGN.md in this skill folder.
---

# Nvidia — Open Design Design System
