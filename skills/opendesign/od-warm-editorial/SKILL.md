---
name: od-warm-editorial
description: >-
  Open Design design system (Warm Editorial). Use when the user wants an interface
  styled as Warm Editorial, or any design task where this aesthetic fits the brief.
  Full spec: DESIGN.md in this skill folder.
---

# Warm Editorial — Open Design Design System
