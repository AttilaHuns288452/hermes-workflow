...
name: od-linear-app
description: >-
  Open Design design system (Linear App). Use when the user wants an interface
  styled as Linear App, or any design task where this aesthetic fits the brief.
  Full spec: DESIGN.md in this skill folder.
---

# Linear App — Open Design Design System
