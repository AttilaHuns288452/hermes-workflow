...
name: od-cursor
description: >-
  Open Design design system (Cursor). Use when the user wants an interface
  styled as Cursor, or any design task where this aesthetic fits the brief.
  Full spec: DESIGN.md in this skill folder.
---

# Cursor — Open Design Design System
