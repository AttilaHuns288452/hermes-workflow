...
name: od-renault
description: >-
  Open Design design system (Renault). Use when the user wants an interface
  styled as Renault, or any design task where this aesthetic fits the brief.
  Full spec: DESIGN.md in this skill folder.
---

# Renault — Open Design Design System
