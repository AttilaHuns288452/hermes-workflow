...
name: od-ibm
description: >-
  Open Design design system (Ibm). Use when the user wants an interface
  styled as Ibm, or any design task where this aesthetic fits the brief.
  Full spec: DESIGN.md in this skill folder.
---

# Ibm — Open Design Design System
