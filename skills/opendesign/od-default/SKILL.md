...
name: od-default
description: >-
  Open Design design system (Default). Use when the user wants an interface
  styled as Default, or any design task where this aesthetic fits the brief.
  Full spec: DESIGN.md in this skill folder.
---

# Default — Open Design Design System
