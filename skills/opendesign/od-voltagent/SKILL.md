...
name: od-voltagent
description: >-
  Open Design design system (Voltagent). Use when the user wants an interface
  styled as Voltagent, or any design task where this aesthetic fits the brief.
  Full spec: DESIGN.md in this skill folder.
---

# Voltagent — Open Design Design System
