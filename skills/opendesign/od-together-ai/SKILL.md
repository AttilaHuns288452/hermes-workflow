...
name: od-together-ai
description: >-
  Open Design design system (Together Ai). Use when the user wants an interface
  styled as Together Ai, or any design task where this aesthetic fits the brief.
  Full spec: DESIGN.md in this skill folder.
---

# Together Ai — Open Design Design System
