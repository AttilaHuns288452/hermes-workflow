...
name: od-ferrari
description: >-
  Open Design design system (Ferrari). Use when the user wants an interface
  styled as Ferrari, or any design task where this aesthetic fits the brief.
  Full spec: DESIGN.md in this skill folder.
---

# Ferrari — Open Design Design System
