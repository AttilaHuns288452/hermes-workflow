...
name: od-vodafone
description: >-
  Open Design design system (Vodafone). Use when the user wants an interface
  styled as Vodafone, or any design task where this aesthetic fits the brief.
  Full spec: DESIGN.md in this skill folder.
---

# Vodafone — Open Design Design System
