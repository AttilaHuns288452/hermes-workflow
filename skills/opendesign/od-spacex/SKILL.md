...
name: od-spacex
description: >-
  Open Design design system (Spacex). Use when the user wants an interface
  styled as Spacex, or any design task where this aesthetic fits the brief.
  Full spec: DESIGN.md in this skill folder.
---

# Spacex — Open Design Design System
