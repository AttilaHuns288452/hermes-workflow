...
name: od-minimax
description: >-
  Open Design design system (Minimax). Use when the user wants an interface
  styled as Minimax, or any design task where this aesthetic fits the brief.
  Full spec: DESIGN.md in this skill folder.
---

# Minimax — Open Design Design System
