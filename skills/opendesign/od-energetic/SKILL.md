...
name: od-energetic
description: >-
  Open Design design system (Energetic). Use when the user wants an interface
  styled as Energetic, or any design task where this aesthetic fits the brief.
  Full spec: DESIGN.md in this skill folder.
---

# Energetic — Open Design Design System
