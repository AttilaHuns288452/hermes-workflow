...
name: od-luxury
description: >-
  Open Design design system (Luxury). Use when the user wants an interface
  styled as Luxury, or any design task where this aesthetic fits the brief.
  Full spec: DESIGN.md in this skill folder.
---

# Luxury — Open Design Design System
