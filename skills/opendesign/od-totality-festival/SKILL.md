---
name: od-totality-festival
description: >-
  Open Design design system (Totality Festival). Use when the user wants an interface
  styled as Totality Festival, or any design task where this aesthetic fits the brief.
  Full spec: DESIGN.md in this skill folder.
---

# Totality Festival — Open Design Design System

> Imported from Open Design. Follow DESIGN.md (same folder) as the authoritative spec.
> Colour palette, typography, spacing, and component vocabulary are pinned there.
