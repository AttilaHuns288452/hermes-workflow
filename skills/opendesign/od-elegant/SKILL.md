...
name: od-elegant
description: >-
  Open Design design system (Elegant). Use when the user wants an interface
  styled as Elegant, or any design task where this aesthetic fits the brief.
  Full spec: DESIGN.md in this skill folder.
---

# Elegant — Open Design Design System
