...
name: od-replicate
description: >-
  Open Design design system (Replicate). Use when the user wants an interface
  styled as Replicate, or any design task where this aesthetic fits the brief.
  Full spec: DESIGN.md in this skill folder.
---

# Replicate — Open Design Design System
