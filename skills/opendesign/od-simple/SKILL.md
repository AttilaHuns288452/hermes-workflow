...
name: od-simple
description: >-
  Open Design design system (Simple). Use when the user wants an interface
  styled as Simple, or any design task where this aesthetic fits the brief.
  Full spec: DESIGN.md in this skill folder.
---

# Simple — Open Design Design System
