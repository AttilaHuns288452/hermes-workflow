...
name: od-meta
description: >-
  Open Design design system (Meta). Use when the user wants an interface
  styled as Meta, or any design task where this aesthetic fits the brief.
  Full spec: DESIGN.md in this skill folder.
---

# Meta — Open Design Design System
