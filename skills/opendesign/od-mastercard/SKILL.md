...
name: od-mastercard
description: >-
  Open Design design system (Mastercard). Use when the user wants an interface
  styled as Mastercard, or any design task where this aesthetic fits the brief.
  Full spec: DESIGN.md in this skill folder.
---

# Mastercard — Open Design Design System
