...
name: od-bmw-m
description: >-
  Open Design design system (Bmw M). Use when the user wants an interface
  styled as Bmw M, or any design task where this aesthetic fits the brief.
  Full spec: DESIGN.md in this skill folder.
---

# Bmw M — Open Design Design System
