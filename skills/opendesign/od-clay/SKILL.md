...
name: od-clay
description: >-
  Open Design design system (Clay). Use when the user wants an interface
  styled as Clay, or any design task where this aesthetic fits the brief.
  Full spec: DESIGN.md in this skill folder.
---

# Clay — Open Design Design System
