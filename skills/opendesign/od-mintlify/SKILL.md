...
name: od-mintlify
description: >-
  Open Design design system (Mintlify). Use when the user wants an interface
  styled as Mintlify, or any design task where this aesthetic fits the brief.
  Full spec: DESIGN.md in this skill folder.
---

# Mintlify — Open Design Design System
