---
name: od-mission-control
description: >-
  Open Design design system (Mission Control). Use when the user wants an interface
  styled as Mission Control, or any design task where this aesthetic fits the brief.
  Full spec: DESIGN.md in this skill folder.
---

# Mission Control — Open Design Design System
