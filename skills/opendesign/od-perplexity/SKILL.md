...
name: od-perplexity
description: >-
  Open Design design system (Perplexity). Use when the user wants an interface
  styled as Perplexity, or any design task where this aesthetic fits the brief.
  Full spec: DESIGN.md in this skill folder.
---

# Perplexity — Open Design Design System
