...
name: od-opencode-ai
description: >-
  Open Design design system (Opencode Ai). Use when the user wants an interface
  styled as Opencode Ai, or any design task where this aesthetic fits the brief.
  Full spec: DESIGN.md in this skill folder.
---

# Opencode Ai — Open Design Design System
