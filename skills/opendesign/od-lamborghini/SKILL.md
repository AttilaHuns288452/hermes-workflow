...
name: od-lamborghini
description: >-
  Open Design design system (Lamborghini). Use when the user wants an interface
  styled as Lamborghini, or any design task where this aesthetic fits the brief.
  Full spec: DESIGN.md in this skill folder.
---

# Lamborghini — Open Design Design System
