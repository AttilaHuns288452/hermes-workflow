...
name: od-composio
description: >-
  Open Design design system (Composio). Use when the user wants an interface
  styled as Composio, or any design task where this aesthetic fits the brief.
  Full spec: DESIGN.md in this skill folder.
---

# Composio — Open Design Design System
