...
name: od-x-ai
description: >-
  Open Design design system (X Ai). Use when the user wants an interface
  styled as X Ai, or any design task where this aesthetic fits the brief.
  Full spec: DESIGN.md in this skill folder.
---

# X Ai — Open Design Design System
