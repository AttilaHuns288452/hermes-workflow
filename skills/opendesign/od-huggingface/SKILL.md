...
name: od-huggingface
description: >-
  Open Design design system (Huggingface). Use when the user wants an interface
  styled as Huggingface, or any design task where this aesthetic fits the brief.
  Full spec: DESIGN.md in this skill folder.
---

# Huggingface — Open Design Design System
