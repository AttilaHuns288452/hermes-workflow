...
name: od-ollama
description: >-
  Open Design design system (Ollama). Use when the user wants an interface
  styled as Ollama, or any design task where this aesthetic fits the brief.
  Full spec: DESIGN.md in this skill folder.
---

# Ollama — Open Design Design System
