...
name: od-dashboard
description: >-
  Open Design design system (Dashboard). Use when the user wants an interface
  styled as Dashboard, or any design task where this aesthetic fits the brief.
  Full spec: DESIGN.md in this skill folder.
---

# Dashboard — Open Design Design System
