...
name: od-canva
description: >-
  Open Design design system (Canva). Use when the user wants an interface
  styled as Canva, or any design task where this aesthetic fits the brief.
  Full spec: DESIGN.md in this skill folder.
---

# Canva — Open Design Design System
