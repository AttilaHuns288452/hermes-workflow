...
name: od-duolingo
description: >-
  Open Design design system (Duolingo). Use when the user wants an interface
  styled as Duolingo, or any design task where this aesthetic fits the brief.
  Full spec: DESIGN.md in this skill folder.
---

# Duolingo — Open Design Design System
