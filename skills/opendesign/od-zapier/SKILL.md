...
name: od-zapier
description: >-
  Open Design design system (Zapier). Use when the user wants an interface
  styled as Zapier, or any design task where this aesthetic fits the brief.
  Full spec: DESIGN.md in this skill folder.
---

# Zapier — Open Design Design System
