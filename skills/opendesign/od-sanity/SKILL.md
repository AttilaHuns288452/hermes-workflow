...
name: od-sanity
description: >-
  Open Design design system (Sanity). Use when the user wants an interface
  styled as Sanity, or any design task where this aesthetic fits the brief.
  Full spec: DESIGN.md in this skill folder.
---

# Sanity — Open Design Design System
