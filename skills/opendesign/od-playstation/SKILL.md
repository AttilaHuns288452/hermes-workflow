...
name: od-playstation
description: >-
  Open Design design system (Playstation). Use when the user wants an interface
  styled as Playstation, or any design task where this aesthetic fits the brief.
  Full spec: DESIGN.md in this skill folder.
---

# Playstation — Open Design Design System
