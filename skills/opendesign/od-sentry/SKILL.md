...
name: od-sentry
description: >-
  Open Design design system (Sentry). Use when the user wants an interface
  styled as Sentry, or any design task where this aesthetic fits the brief.
  Full spec: DESIGN.md in this skill folder.
---

# Sentry — Open Design Design System
