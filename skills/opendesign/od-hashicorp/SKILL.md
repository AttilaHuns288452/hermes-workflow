...
name: od-hashicorp
description: >-
  Open Design design system (Hashicorp). Use when the user wants an interface
  styled as Hashicorp, or any design task where this aesthetic fits the brief.
  Full spec: DESIGN.md in this skill folder.
---

# Hashicorp — Open Design Design System
