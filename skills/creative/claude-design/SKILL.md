...
- ecosystem documentation dashboards — educational HTML sites that document an agent's own workflow, skills, tools, model routing, and integrated knowledge graph (see `references/ecosystem-dashboard.md`)
...
This skill ships reference files for specific design patterns. Load them via `skill_view(name="claude-design", file_path="references/<file>")`:

| File | Use when |
|---|---|
| `references/ecosystem-dashboard.md` | Building an educational HTML site documenting an AI agent's ecosystem — skills, tools, model routing, pipeline, /decide flow, and embedded knowledge graph |
